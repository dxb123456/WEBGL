...
var SampleAnimation = (function () {
    function SampleAnimation() {
        ...
        */
        ...
        ///开始加载
        load.load("resource/LingTong/baihu.esm");
        this.InitCameraCtl();
        ///启动Canvas。
    ...
    */
    p.onLoad = function (e) {
        ...
        ///开始读取贴图 
        loadtex.load("resource/LingTong/baihu.jpg");
        loadtex["mat"] = mat;
        ...
        ///开始读取动画
        loadAniattack.load("resource/LingTong/attck.eam");
        ///开启拣选
